...
public class CalculatorController implements Initializable
{
    ...
    {
        salt.textProperty().bind(total.getStringProperty("salt"));
        protein.textProperty().bind(total.getStringProperty("protein"));
        super_fat.textProperty().bind(total.getStringProperty("superFat"));
        sugar.textProperty().bind(total.getStringProperty("sugar"));
        fat.textProperty().bind(total.getStringProperty("fat"));
        carbonhydrates.textProperty().bind(total.getStringProperty("carbohydrates"));
        joules.textProperty().bind(total.getStringProperty("kj"));
        kcal.textProperty().bind(total.getStringProperty("kcal"));
        fiber.textProperty().bind(total.getStringProperty("fiber"));
    }
